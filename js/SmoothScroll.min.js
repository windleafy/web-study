...
function() {
	...
	function n(e, t, o) {
		...
		if (q.push({
			...
			l = function() {
				...
				i ? window.scrollBy(r, a) : (r && (e.scrollLeft += r), a && (e.scrollTop += a)),
				t || o || (q = []),
	...
	function r(e) {
		...
		return K && (e.wheelDeltaX && b(e.wheelDeltaX, 120) && (a = -120 * (e.wheelDeltaX / Math.abs(e.wheelDeltaX))), e.wheelDeltaY && b(e.wheelDeltaY, 120) && (i = -120 * (e.wheelDeltaY / Math.abs(e.wheelDeltaY)))),
	...
	function S(e) {
		...
		1 > e ? t = e - (1 - Math.exp( - e)) : (o = Math.exp( - 1), e -= 1, n = 1 - Math.exp( - e), t = o + n * (1 - o)),
		t * z.pulseNormalize
	}
	function x(e) {
